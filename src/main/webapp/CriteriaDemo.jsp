...
//cr.setFirstResult(1);
//cr.setMaxResults(2);
//to retrieve records Having first Name starting with s
//cr.add(Restictions.like("name","s%"));
//cr.add(Restrictions.eq("id",5));

//greater demo
//cr.add(Restrictions.gt("id",2));
//cr.add(Restrictions.like("name","s%")); //Combining two criteria AND operation
